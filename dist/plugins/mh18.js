        ...
        this.url = resolvePluginUpdateUrl("mh18.js"), this.settings = {
            ...
            loadInfo: async e => {
                ...
                const t = await loadMhLikeBaseComicInfoFeature({
                    ...
                    mangaId: r
                }), this.headers), a = new HtmlDocument(o.body), i = {};
                for (let e of a.querySelectorAll(".chapteritem")) {
                    const t = e.querySelector("a");
                    i[`${t.attributes["data-ms"]}@${t.attributes["data-cs"]}`] = e.querySelector(".chaptertitle").text;
                }
            ...
            loadEp: async (e, t) => {
                const r = t.split("@"), o = await Network.get(this.chapterRequests.buildChapterContentRequestUrl({
                    mangaId: r[0],
                    chapterId: r[1]
                }), this.headers);
                if (200 !== o.status) throw `Invalid status code: ${o.status}`;
                const a = new HtmlDocument(o.body), i = [];
                for (let e of a.querySelector("#chapcontent").querySelectorAll("img")) i.push(e.attributes["data-src"] ? e.attributes["data-src"] : e.attributes.src);
                return {
                    images: i
                };
            },
