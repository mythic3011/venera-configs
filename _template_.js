class NewComicSource extends ComicSource {
  ...
  constructor() {
    ...
    // update url
    this.url = resolvePluginUpdateUrl("your_plugin.js");

    // Define plugin metadata and request allowlists in plugin.config.json.
    // Keep the source focused on implementation details, not duplicated config values.
    // Use CORS-style origin allowlists in config; avoid enumerating individual URLs here.
